...
| Chapter 6: Penetration Testing Methodology | 9,748 | 265 | 19.5 |
| Chapter 7: Reconnaissance and Open-Source Intelligence | 7,202 | 381 | 14.4 |
| Chapter 8: Scanning and Enumeration | 7,195 | 816 | 14.4 |
| Chapter 9: Exploitation and Post-Exploitation | 17,380 | 587 | 34.8 |
| Chapter 10: Web Application Security | 7,266 | 202 | 14.5 |
| Chapter 11: Network Defense and Hardening | 7,114 | 258 | 14.2 |
| Chapter 12: Intrusion Detection and Prevention Systems | 8,894 | 1,114 | 17.8 |
| Chapter 13: Digital Forensics | 10,444 | 875 | 20.9 |
...
*1,559 markdown words (3.1 pages); 0 code words.*

| Section | Words |
|---|---:|
| Course Mapping | 446 |
|     Adapting the Reading Load | 418 |
...
| 2.21 Post-Quantum Standards and the Migration Timeline | 282 |
...
*16,436 markdown words (32.9 pages); 374 code words.*
...
| 3.13 The Access Link: How a Network Connects to the Internet | 556 |
|     Exercises | 72 |
|     Answer Key | 149 |
| 3.14 Premises Wireless: Wi-Fi Generations, Extenders, and Mesh | 563 |
|     Exercises | 59 |
|     Answer Key | 145 |
| Chapter Summary | 215 |
...
*12,541 markdown words (25.1 pages); 469 code words.*
...
*17,380 markdown words (34.8 pages); 587 code words.*
...
| 9.4 Memory Corruption: The Stack, the Heap, and Buffer Overflows | 344 |
...
| 9.9 Passive and Static Analysis: Reverse Engineering for Exploitation | 208 |
|     Privilege Escalation in Depth | 193 |
|     Post-Exploitation, Lateral Movement, and Defense Evasion | 386 |
...
|     Exercises | 73 |
|     Answer Key | 116 |
| 9.29 Return-Oriented Programming, Worked | 444 |
|     Exercises | 64 |
|     Answer Key | 120 |
...
|     Exercises | 58 |
|     Answer Key | 113 |
| 9.33 Patch Diffing and N-Day Exploitation | 417 |
|     Exercises | 60 |
|     Answer Key | 127 |
| 9.34 Toward Automated Vulnerability Discovery: Symbolic Execution | 379 |
|     Exercises | 49 |
|     Answer Key | 140 |
| 9.35 A Field Guide to Bug Classes | 470 |
|     Exercises | 76 |
|     Answer Key | 125 |
...
| 10.2 The OWASP Top 10 | 67 |
|     Broken Access Control | 164 |
|     The OWASP Top 10:2025 | 424 |
...
|     Database Models: Traditional and Modern | 759 |
...
*7,114 markdown words (14.2 pages); 258 code words.*
...
|     DNS Sinkholing | 54 |
|     NXDOMAIN and the DNS_PROBE_FINISHED_NXDOMAIN Error | 249 |
...
| 11.11 Network Monitoring and Visibility | 201 |
...
*8,894 markdown words (17.8 pages); 1,114 code words.*
...
*10,444 markdown words (20.9 pages); 875 code words.*
...
*9,771 markdown words (19.5 pages); 828 code words.*
...
*29,945 markdown words (59.9 pages); 423 code words.*
...
| 15.15 Mobile and Cross-Platform Malware | 136 |
|     Exercises | 86 |
|     Answer Key | 151 |
...
|     Exercises | 73 |
|     Answer Key | 133 |
| 15.27 Linux and ELF Malware Analysis | 411 |
|     Exercises | 61 |
|     Answer Key | 90 |
...
|     Exercises | 128 |
|     Answer Key | 377 |
| 15.38 From Source Code to Binary: Toolchains, Artifacts, and What Separates Malware from Software | 1,492 |
|     Exercises | 231 |
|     Answer Key | 368 |
| 15.39 Reverse Engineering as a Discipline: Software, Hardware, AI, Law, and Careers | 748 |
|     What Reverse Engineering Is, and Why It Is Done | 546 |
|     Is It Reverse Engineering? Four Questions and Twelve Cases | 1,180 |
|     Three Domains | 391 |
...
*6,888 markdown words (13.8 pages); 366 code words.*
...
|     Tooling, Chapter Mapping, and Workflow | 234 |
...
|     Offensive AI | 151 |
|     Defensive AI | 77 |
|     The OWASP Top 10 for LLM Applications (2025) | 337 |
...
|     Case Study: A Privacy-Preserving ML Research Program (SigML, SplitML, Fairis) | 2,423 |
...
|     Cloud Storage Models: Object, Block, and File | 857 |
|     Storage Media: SSD versus HDD | 639 |
...
|     AI for Security and Security for AI | 263 |
...
| 17.12 Securing AI Systems: Agentic AI, Red Teaming, and the Model Supply Chain | 301 |
...
*6,765 markdown words (13.5 pages); 387 code words.*
...
| 18.11 Anonymity Networks and Privacy-Focused Operating Systems | 891 |
|     Exercises | 79 |
|     Answer Key | 154 |
...
| 19.6 Common Compliance Frameworks | 192 |
|     Frameworks, Methodologies, and Tools | 117 |
|     NIST CSF, ISO/IEC 27001, and the RMF Compared | 195 |
|     FISMA in Depth | 275 |
|     NIST SP 800-53 in Depth | 262 |
|     FedRAMP in Depth | 399 |
...
| 20.3 The Purdue Model and Network Segmentation | 96 |
...
|     K.2.3 Intrusion Detection and Prevention Systems (pairs with Chapters 11 and 12) | 127 |
